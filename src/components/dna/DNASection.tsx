  ...
  return [
    {
      ...
      key_signals: [
        { label: "Risk Profile", value: riskLabel, explanation: `Risk score: ${scores.risk_score}/10 — how much variance you're comfortable with.` },
        { label: "Structure Preference", value: structureLabel, explanation: `Structure score: ${scores.structure_score}/10 — how you prefer to organize work.` },
        { label: "Uncertainty Tolerance", value: uncertaintyLabel, explanation: `Uncertainty score: ${scores.uncertainty_score}/10 — how you handle ambiguous signals.` },
        { label: "Readiness Level", value: readinessLabel, explanation: `Readiness score: ${scores.readiness_score}/10 — where you are on the path to action.` },
        { label: "Time Availability", value: timeLabel, explanation: `Capacity score: ${scores.constraint_score}/10 — focused hours you can commit.` },
        { label: "Energy Stability", value: energyStabilityLabel, explanation: `Energy score: ${scores.energy_stability_score}/10 — how consistently energizing work shows up.` },
      ],
    ...
    },
    {
      ...
      hero_statement: scores.motivation_driver.slice(0, 80),
      description: scores.motivation_driver,
      summary: scores.success_feeling?.slice(0, 100) || scores.motivation_driver.slice(0, 100),
      key_signals: [
    ...
    },
    {
      ...
      description: `You work best ${structureLabel === "Independent" ? "alone, sharing once it's ready" : structureLabel === "Small Team" ? "alongside a few trusted collaborators" : "with the energy of a team or community"}. You have ${timeLabel.toLowerCase()} capacity right now.`,
      summary: `${structureLabel} • ${timeLabel} capacity`,
      key_signals: [
    ...
    },
    {
      ...
      description: scores.energy_drains
      ...
      summary: `${energyStabilityLabel} energy pattern`,
      key_signals: [
    ...
    },
    {
      ...
      description: scores.non_negotiable || "The trade-offs that matter most to you — and the edges of what's tolerable.",
      summary: scores.non_negotiable?.slice(0, 100) || "",
      key_signals: [
