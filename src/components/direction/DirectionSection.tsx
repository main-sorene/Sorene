...
export const DirectionSection = () => {
  ...
  useEffect(() => {
    ...
    // If the user came from the onboarding chat, use the collected concept so the
    // card is anchored to their actual idea rather than being a generic fit card.
    let concept = "";
  ...
  }, [eligibility, isGeneratingMore, generateMore, generateRecipeCard, searchParams]);
